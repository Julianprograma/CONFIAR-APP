...
<head>
    <meta charset="UTF-8">
    <title>Ingreso | Confiar App</title>
        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="field">
                    ...
                    <input autofocus type="email" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="tu@correo.com">
                </div>
                <div class="field">
            ...
            <div class="footer"> 
                <small>¿No tienes cuenta? <a style="color:#9cc9ff;text-decoration:none;" href="{{ route('register') }}">Crear cuenta</a></small><br>
